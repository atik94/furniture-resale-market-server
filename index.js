...
async function run() {
  try {
    const usersCollection = client.db("furniture-resale-market").collection("users");
...
app.get("/", async (req, res) => {
  res.send("Furniture resale market server is running");
});

app.listen(port, () => console.log(`furniture resale market running on ${port}`));
